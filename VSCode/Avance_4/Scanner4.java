...
public class Scanner4 extends JFrame {
    ...
    private void construirUI() {
        ...
        lbl_estadoTS.setForeground(new Color(0, 150, 0)); // Color verde
        ...
        panelOpcionesTS.add(Box.createHorizontalStrut(10)); // Espacio
        ...
        gbc.gridy = 1;
        gbc.weighty = 0.4; // Ocupa el 40% del alto disponible
        ...
        gbc.gridy = 2;
        gbc.weighty = 0.6; // Ocupa el 60% del alto disponible
        cp.add(panelResultados, gbc);
    }

    // ── LÓGICA DE TABLAS SEMÁNTICAS ───────────────────────────────────────────
    
    private Object actualizarTS() {
        // TODO Auto-generated method stub
        throw new UnsupportedOperationException("Unimplemented method 'actualizarTS'");
    }
    ...
    private void ts_inicializar() {
        ...
        lbl_estadoTS.setForeground(new Color(0, 100, 200)); // Azul oscuro
    }
    ...
    private void ts_actualizar() {
        ...
        lbl_estadoTS.setForeground(new Color(0, 150, 0)); // Verde
    }
    ...
    private void analizarSQL() {
        ...
        if (!todosErrores.isEmpty()) {
            ...
            nb.setSelectedIndex(6); // Foco directo a la pestaña de errores
        } else {
            ...
            void parsear_condicion(Map<String, Integer> mapa_tablas, List<TablaValida> tablas_validas) {
                ...
                if (t != null && t.tipo == 1 && t.lexema.equals("IN")) {
                    ...
                    if (t2 != null && (t2.tipo == 4 || t2.tipo == 6)) {
                        if (!ts_tablas.isEmpty() && !tablas_validas.isEmpty() && t2.tipo == 6 && t2.sub == 61) {
